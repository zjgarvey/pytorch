...
static PyObject* THPModule_setUserMiopenUseHipdnn(
    PyObject* _unused,
    PyObject* arg) {
  HANDLE_TH_ERRORS
  TORCH_CHECK(
      PyBool_Check(arg),
      "set_miopen_use_hipdnn expects a bool, "
      "but got ",
      THPUtils_typename(arg));
  at::globalContext().setUserMiopenUseHipdnn(arg == Py_True);
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}

static PyObject* THPModule_userMiopenUseHipdnn(
    PyObject* _unused,
    PyObject* noargs) {
...
static std::initializer_list<PyMethodDef> TorchMethods = {
    ...
    {"_get_miopen_use_hipdnn",
     THPModule_userMiopenUseHipdnn,
     METH_NOARGS,
     nullptr},
    {"_set_miopen_use_hipdnn",
     THPModule_setUserMiopenUseHipdnn,
     METH_O,
     nullptr},
